...
export default {
  ...
  methods: {
    ...
    TakeOut(){
      JSON.parse(localstorage.getItem('user')).username=this.username
      JSON.parse(localstorage.getItem('user')).password=this.password
    }
  },
  mounted() {
    this.TakeOut()
