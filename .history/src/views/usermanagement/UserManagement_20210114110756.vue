<template>
  <div class="back">
    <!-- SEARCH -->
    <ai-search :data="StrSearch" :options="options" :visible="visible" >
      <template #searchs>
        <el-input
          placeholder="请输入搜索内容"
          v-model="input2"
    ...
    <!-- ADD -->
    <ai-dialog :options="options" :visible="visible" :modal-append-to-body="true" :hide-required-asterisk="true"
    >
      <template #btn>
